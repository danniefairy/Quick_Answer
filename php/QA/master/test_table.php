...
<body>
	...
	<div id="panel" style="margin:auto;width:40%" 	><h2 style="font-size:1.7vw;">aeit.nutc.edu.tw/Mifriend/php/QA</h2></div>
	<h3 align="center" style="font-family:Microsoft JhengHei;"><?php echo "挑戰人數: ".mysqli_num_rows($result)."人"; ?></h3>
