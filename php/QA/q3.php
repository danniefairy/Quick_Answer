...
<script type="text/javascript">
	...
	function countdown(){
		...
		*/
			...
			document.getElementById("question").innerHTML="請問下列哪些不為SAA所屬的工作類別?";
	...
	<div class="main">
		...
		<div class="main-row">
			...
			<div class="pricing-grid agileits-shadow">
				...
				<div class="price-bg">
					<p class="price-label-2"><span>Q3</span></p>
					<ul class="count">
					...
					<div style="text-align:center;">
						<br>
						<button id="send1" type="button" class="btn btn-success"  style=" height:35px; width:120px;" disabled="true">CGC-Surface</button>
						<br><br>
						<button id="send2" type="button" class="btn btn-info" style=" height:35px; width:120px;" disabled="true">Windows 天團</button>
						<br><br>
						<button id="send3" type="button" class="btn btn-danger" style=" height:35px; width:120px;" disabled="true">Office 大使</button>
						<br>
					</div>
