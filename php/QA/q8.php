...
<script type="text/javascript">
	...
	function countdown(){
		...
		*/
			...
			document.getElementById("question").innerHTML="請問實習時間為多久?";
	...
	<div class="main">
		...
		<div class="main-row">
			...
			<div class="pricing-grid agileits-shadow">
				...
				<div class="price-bg">
					<p class="price-label-2"><span>Q8</span></p>
					<ul class="count">
					...
					<div style="text-align:center;">
						<br>
						<button id="send1" type="button" class="btn btn-success"  style=" height:35px; width:120px;" disabled="true">一年</button>
						<br><br>
						<button id="send2" type="button" class="btn btn-info" style=" height:35px; width:120px;" disabled="true">半年</button>
						<br><br>
						<button id="send3" type="button" class="btn btn-danger" style=" height:35px; width:120px;" disabled="true">暑假2個月</button>
						<br>
					</div>
