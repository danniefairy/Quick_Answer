...
<script type="text/javascript">
	...
	function countdown(){
		...
		*/
	    ...
	    send3.addEventListener("click", function(){window.location.href='q'+next_question+'_insert.php?score='+(Number(t)+Number(total_score))+'&name='+name+'&school='+school;});
		...
		*/
			...
			document.getElementById("question").innerHTML="請問微軟中南部辦公室哪一個職位較多?";
	...
	<div class="main">
		...
		<div class="main-row">
			...
			<div class="pricing-grid agileits-shadow">
				...
				<div class="price-bg">
					<p class="price-label-2"><span>Q2</span></p>
					<ul class="count">
					...
					<div style="text-align:center;">
						<br>
						<button id="send1" type="button" class="btn btn-success"  style=" height:35px; width:120px;" disabled="true">AA</button>
						<br><br>
						<button id="send2" type="button" class="btn btn-info" style=" height:35px; width:120px;" disabled="true">MAA</button>
						<br><br>
						<button id="send3" type="button" class="btn btn-danger" style=" height:35px; width:120px;" disabled="true">SAA</button>
						<br>
					</div>
