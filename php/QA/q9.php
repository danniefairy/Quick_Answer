...
<script type="text/javascript">
	...
	function countdown(){
		...
		*/
		...
		send1.addEventListener("click", function(){window.location.href='q'+next_question+'_insert.php?score='+(Number(0)+Number(total_score))+'&name='+name+'&school='+school;});
	    send2.addEventListener("click", function(){window.location.href='q'+next_question+'_insert.php?score='+(Number(t)+Number(total_score))+'&name='+name+'&school='+school;});
		...
		*/
			...
			document.getElementById("question").innerHTML="請問每一屆微軟體驗計畫招收多少實習生?";
	...
	<div class="main">
		...
		<div class="main-row">
			...
			<div class="pricing-grid agileits-shadow">
				...
				<div class="price-bg">
					<p class="price-label-2"><span>Q9</span></p>
					<ul class="count">
					...
					<div style="text-align:center;">
						<br>
						<button id="send1" type="button" class="btn btn-success"  style=" height:35px; width:120px;" disabled="true">約50人</button>
						<br><br>
						<button id="send2" type="button" class="btn btn-info" style=" height:35px; width:120px;" disabled="true">約100人</button>
						<br><br>
						<button id="send3" type="button" class="btn btn-danger" style=" height:35px; width:120px;" disabled="true">約150人</button>
						<br>
					</div>
