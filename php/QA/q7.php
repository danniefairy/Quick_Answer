...
<script type="text/javascript">
	...
	function countdown(){
		...
		*/
			...
			document.getElementById("question").innerHTML="下列哪一項資源無法了解到微軟實習體驗計畫的活動內容?";
	...
	<div class="main">
		...
		<div class="main-row">
			...
			<div class="pricing-grid agileits-shadow">
				...
				<div class="price-bg">
					<p class="price-label-2"><span>Q7</span></p>
					<ul class="count">
					...
					<div style="text-align:center;">
						<br>
						<button id="send1" type="button" class="btn btn-success"  style=" height:35px; width:120px;" disabled="true">校園巡迴講座</button>
						<br><br>
						<button id="send2" type="button" class="btn btn-info" style=" height:35px; width:120px;" disabled="true">微軟官方網站</button>
						<br><br>
						<button id="send3" type="button" class="btn btn-danger" style=" height:35px; width:120px;" disabled="true">臉書粉絲團</button>
						<br>
					</div>
